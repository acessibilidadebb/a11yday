...
export default function Primer() {
  ...
  return (
    <div>
      <Modal titleId="primer-title" descriptionId='primer-description' isOpen={isModalOpen} onClose={handleClose}>
        <div className="primer-container">
          ...
          <div id="primer-description">
            <p className="primer-paragraph">
              ...
              vida mais legal, né? Porém, muitos de nós possuímos
              características que necessitam de atitudes específicas para que
              essa troca aconteça e seja boa para todos. Você sabe quais
              atitudes deve ter para que isso aconteça?
            </p>
            <p className="primer-paragraph">
            ...
            <p className="primer-paragraph">
              ...
              pessoa tem uma deficiência que pode não ser percebida de imediato.
              A medida objetiva promover a conscientização e o respeito a
              direitos previstos, como atendimento prioritário. Ao visualizar um
              portador do cordão, saiba, portanto, que o indivíduo poderá
              precisar de uma ajuda extra, compreensão ou apenas mais tempo em
          ...
          <ol className="primer-list">
            ...
            <li>
              Se tiver dificuldade para compreender o que ela está dizendo, não
              se acanhe em pedir para que repita.
            </li>
          </ol>
          ...
          <p className="primer-paragraph">
            ...
            pergunte como deve proceder e não se ofenda caso a ajuda for
            recusada. Evite tomar decisões por ela.
          </p>
          <ol className="primer-list">
            <li>
            ...
            <li>
              Não faça julgamentos. Evite comentários sobre a aparência física
              da pessoa;
            </li>
            <li>
            ...
            <li>
              ...
              do rosto da pessoa e o seu, se abaixe ou se sente, mantendo a
              menor diferença possível entre o nível do seu olhar e o da pessoa;
            </li>
            <li>
              Não a ignore. Inclua a pessoa com deficiência física normalmente
          ...
          <ol className="primer-list">
            ...
            <li>
              Pergunte à pessoa se ela necessita de auxílio para a locomoção.
              Caso ela aceite, ofereça o seu braço dobrado para que ela se
              apoie. Não puxe ou empurre a pessoa, pois isso pode causar
              acidentes. Não toque na pessoa sem permissão;
            </li>
            <li>
              Dê instruções claras e objetivas. Seja o mais específico possível
              e use pontos de referência precisos, como "à sua direita", "à sua
              esquerda", "à frente";
            </li>
            <li>
            ...
            <li>
              ...
              ela expresse por si mesma e, mesmo que esteja acompanhada,
              dirija-se diretamente a ela, evitando falar apenas com o
              acompanhante.
            </li>
            <li>
              Se for cumprimentar uma pessoa com deficiência visual com um
              abraço ou um aperto de mão, anuncie o que pretende fazer para que
              ela possa corresponder e se preparar.
            </li>
          </ol>
          ...
          <ol className="primer-list">
            ...
            <li>
              Seja paciente. Pessoas com deficiência podem precisar de mais
              tempo para processar informações, e podem se sentir
              sobrecarregadas em ambientes sociais. Respeite seu ritmo;{' '}
            </li>
            <li>
              Use a comunicação não verbal. Gestos, expressões faciais e o tom
              de voz podem complementar a comunicação verbal;
            </li>
            <li>
              Adapte-se à situação e esteja disposto a ajustar sua comunicação
